...
echo F|xcopy /i /y %2BuildFiles\TWAIN_32\Orchard_Utilities_32.exe %1TWAIN_32\Orchard_Utilities_32.exe

:: Copy TWAINDSM.dll
echo F|xcopy /i /y %2BuildFiles\TWAIN_32\TWAINDSM.dll %1TWAIN_32\TWAINDSM.dll
